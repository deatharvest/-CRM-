...
<html>
 ...
 <body>xStoreInfo-add
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="xStoreInfoController.do?doAdd" tiptype="1">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="storeName" name="storeName" type="text" style="width: 150px" class="inputxt"  
								               ...
								               >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">店名</label>
						</td>
				</tr>
				<tr>
					<td align="right">
