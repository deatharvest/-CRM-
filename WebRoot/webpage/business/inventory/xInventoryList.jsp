...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="XInventoryList" checkbox="true" fitColumns="false" title="库存信息" actionUrl="xInventoryController.do?datagrid" idField="id" fit="true" queryMode="group">
